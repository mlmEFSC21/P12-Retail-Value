...
function calculateDailyProductValue(productNo, dailyQuantitySold) {
    switch (productNo) {
        case 1:
            price = 2.98;
            value1 = parseFloat(price * dailyQuantitySold);
            dailyProductValue[0] = value1.toFixed(2);
            break;
        case 2:
            price = 4.5;
            value2 = parseFloat(price * dailyQuantitySold);
            dailyProductValue[1] = value2.toFixed(2);
            break;
        case 3:
            price = 9.98;
            value3 = parseFloat(price * dailyQuantitySold);
            dailyProductValue[2] = value3.toFixed(2);
            break;
        case 4:
            price = 4.49;
            value4 = parseFloat(price * dailyQuantitySold);
            dailyProductValue[3] = value4.toFixed(2);
            break;
        case 5:
            price = 6.87;
            value5 = parseFloat(price * dailyQuantitySold);
...
function calculateDailyTotalValue(dailyProductValue) {
    dailyTotal = dailyProductValue.reduce(function (a, b) {
        return a + b;
    });
    dailyTotalValue = parseFloat(dailyTotal).toFixed(2);
}
