...
function calculateDailyProductValue(productNo) {
    switch (productNo) {
        case 1:
            ...
            dailyProductValue[0] = parseFloat(value1).toFixed(2);
            break;
        case 2:
            price = 4.5;
            value2 = price * dailyQuantitySold;
            dailyProductValue[1] = parseFloat(value2).toFixed(2);
            break;
        case 3:
            price = 9.98;
            value3 = price * dailyQuantitySold;
            dailyProductValue[2] = parseFloat(value3).toFixed(2);
            break;
        case 4:
            price = 4.49;
            value4 = price * dailyQuantitySold;
            dailyProductValue[3] = parseFloat(value4).toFixed(2);
            break;
        case 5:
            price = 6.87;
            value5 = price * dailyQuantitySold;
            dailyProductValue[4] = parseFloat(value5).toFixed(2);
            break;
        default:
            price = 0.0;
            break;
