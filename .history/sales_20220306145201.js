...
function populateTable() {
    ...
    switch (new Date().getDay()) {
        case 0:
            ...
            prod1.innerHTML = `$${dailyProductValue[0].toPrecision(5)}`;
            prod2.innerHTML = `$${dailyProductValue[1].toPrecision(5)}`;
            prod3.innerHTML = `$${dailyProductValue[2].toPrecision(5)}`;
            prod4.innerHTML = `$${dailyProductValue[3].toPrecision(5)}`;
            prod5.innerHTML = `$${dailyProductValue[4].toPrecision(5)}`;
